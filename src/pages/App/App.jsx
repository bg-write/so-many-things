  ...
  state = {
    ...
    erikaThings: [
      {
        ...
        image:
          "https://simplysohealthy.com/wp-content/uploads/2017/03/cmic-1.jpg",
        attributes: ["minty fresh", "chocolate goodness", "feeds the soul"],
      },
      {
        name: "Nasa Blanket",
        image:
          "https://images.fun.com/products/48499/1-1/nasa-icon-microfiber-fleece-throw.jpg",
    ...
    sebastianThings: [
      ...
      },
      {
        name: "cooking",
        image:
          "https://pics.me.me/mean-plastic-i-think-cooking-is-my-calling-the-college-15681275.png",
    ...
    return (
      <>
        ...
        <Route
          exact
          path="/thingslist"
          render={() => <ThingsList erikaThings={this.state.erikaThings} />}
        />
        <Link
          to={{
            pathname: "/thingslist",
        ...
        <Route
          ...
          path="/sebastianlist"
          render={() => (
            <SebastianThing sebastianThings={this.state.sebastianThings} />
          )}
        />
        <Link
          to={{
          ...
          <Route
            exact
            path="/bradylist"
            render={() => <BradyList bradyThings={this.state.bradyThings} />}
          />
        <Link
          to={{
            pathname: "/bradylist",
